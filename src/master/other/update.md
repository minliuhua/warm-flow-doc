...
### v1.4.1 2025-02-15  [升级指南](./news/upgrade_guide/4.html#v1-4-1)

- 新增流程图元数据 @晓华
- 接入仿钉钉设计器 @Zhen@晓华

### v1.4.0  2025-01-15  [升级指南](./news/upgrade_guide/4.html#v1-4-0)
...
- 新增办理人选择项接口 @晓华
- 驳回只能删除目标节点的下级任务 @晓华
- 串行到并行，会产生多条记录，如何解决 @晓华
- [feat] 导入、导出和保存等新增json格式支持 @晓华@xiarigang
- [update] 导入、导出和保存xml格式标识为即将删除，请参照hh-vue切换json方式 @晓华
