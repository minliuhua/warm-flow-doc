...
export default {
  setup() {
    ...
    const fetchData = async () => {
      rzList.value = [
        { title: "Gitee star数超1.8k", src: "https://foruda.gitee.com/images/1737947694071338495/c55d5597_2218307.png" },
    ...
    const navigateTo = () => {
      ...
      var contentToAppend = `<p><a href="https://gitee.com/dromara/warm-flow.git" style="margin-left: 12px;"><img src="https://gitee.com/dromara/warm-flow/badge/star.svg?theme=dark"></a>
          ...
          <a href='https://repo1.maven.org/maven2/org/dromara/warm/'><img src='https://img.shields.io/badge/release_1.6.6-beta_not__have-blue' alt='fork'></a>
        </p>
      `;
