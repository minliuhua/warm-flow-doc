...
<input type="hidden" id="https://x-file-storage.xuyanwu.cn/assets/link/member-project-pure.md">
...
<h1 id="🚀dromara成员项目" class="anchor">
    🚀Dromara成员项目
</h1>
...
<div class="member-project">
    ...
    <a href="https://x-file-storage.xuyanwu.cn" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/logo3.svg" alt="x-file-storage" title="一站式文件存储，聚合对接所有主流存储平台">
    </a>
    ...
    <a href="https://gitee.com/dromara/mybatis-jpa-extra" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/mybatis-jpa-extra.png" alt="mybatis-jpa-extra" title="扩展MyBatis JPA支持，简化CUID操作，增强SELECT分页查询">
    </a>
    <a href="https://gitee.com/dromara/dax-pay" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/dax-pay.png" alt="dax-pay" title="免费开源的支付网关">
    </a>
    <a href="https://gitee.com/dromara/sayOrder" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/sayorder.png" alt="dax-pay" title="基于easyAi引擎的JAVA高性能，低成本，轻量级智能客服。">
    </a>
    ...
    <a href="https://gitee.com/dromara/MilvusPlus" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/MilvusPlus.jpg" alt="MilvusPlus" title="MilvusPlus（简称 MP）是一个 Milvus 的操作工具，旨在简化与 Milvus 向量数据库的交互，为开发者提供类似 MyBatis-Plus 注解和方法调用风格的直观 API,提高效率而生。">
    </a>
    <a href="http://www.easy-query.com/easy-query-doc/" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/easy-query.png" alt="easy-query" title="java下唯一一款同时支持强类型对象关系查询和强类型SQL语法查询的ORM,拥有对象模型筛选、隐式子查询、隐式join、显式子查询、显式join,支持Java/Kotlin">
    </a>
    <a href="https://lijiahangmax.github.io/open-orion/orion-visor/" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/orion-visor.png" alt="orion-visor" title="一款高颜值、现代化的智能运维&轻量堡垒机平台。">
    </a>
    <a href="https://www.ujcms.com/" target="_blank">
        <img src="https://x-file-storage.xuyanwu.cn/assets/link/ujcms.png" alt="orion-visor" title="Java开源网站内容管理系统(java cms)。使用SpringBoot、MyBatis、Vue3、ElementPlus、Vite、TypeScript等技术开发。">
    </a>
